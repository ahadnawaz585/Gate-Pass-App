...
const featurePermission_service_1 = __importDefault(require("../service/featurePermission.service"));
class FeaturePermissionController extends base_controller_1.default {
    constructor() {
        super(...arguments);
